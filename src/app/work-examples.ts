const WORKS = [
  ...
  },
  {
    ...
    "screen": "/assets/images/screens/pembroke.jpg",
  ...
  },
  {
    ...
    "screen": "/assets/images/screens/skout.jpg",
  ...
  {
    "key": "PDXCleanEats",
    "title": "PDX Clean Eats",
    "screen": "/assets/images/screens/pdxcleaneats.jpg",
    "description": "Web application for seaching resturant inspection recods for Portland area resturants. This application recieves it's data from civicapps API and is built using nodejs, express, angularjs, and bootstrap.",
    "url" : "http://www.pdxcleaneats.com/",
    "technologies": [
      {
        "name": "Node.js",
        "icon": "/images/icons/node.png"
      ...
      {
        "name": "CivicApps API",
        "icon": "/images/icons/civicapps.png"
      }
    ]
  },
  {
    "key": "canby",
    "title": "Canby Rodeo",
    "screen": "/assets/images/screens/nwwfair.jpg",
